...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'title' | 'textSnippet' | 'createdAt' | 'updatedAt' | 'id' | 'points' | 'voteStatus'>
  & { creator: (
    { __typename?: 'User' }
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'Post' }
    & Pick<Post, 'title' | 'text' | 'points' | 'id' | 'creatorId' | 'createdAt' | 'updatedAt'>
  ) }
);
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'title' | 'createdAt' | 'text' | 'updatedAt' | 'id' | 'points' | 'voteStatus' | 'commentCount'>
    & { creator: (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'username'>
